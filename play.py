...
UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "lunaupdate")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        hmo = await message.reply_photo(
            photo=thumb, 
            caption=(f"1️⃣ <b>{title1[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID1})__</u>\n ┗ ⚡ __Maintained By Luna Robot__\n\n2️⃣ <b>{title2[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID2})__</u>\n ┗ ⚡ __Maintained By Luna Robot__\n\n3️⃣ <b>{title3[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID3})__</u>\n ┗ ⚡ __Maintained By Luna Robot__\n\n4️⃣ <b>{title4[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID4})__</u>\n ┗v⚡ __Maintained By Luna Robot__\n\n5️⃣ <b>{title5[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID5})__</u>\n ┗ ⚡ __Maintained By Luna Robot__"),    
            reply_markup=InlineKeyboardMarkup(buttons),
        )  
        disable_web_page_preview=True
        return   
    if await is_active_chat(chat_id):
        ...
        photo=thumb,
        reply_markup=InlineKeyboardMarkup(buttons),    
        caption=(f"🏷<b> **title :** </b>[{title[:25]}]({url}) \n⏱<b> **Duration**</b> {duration}\n🎧<b> **Requested by:** </b>{checking}")
    )   
        return await mystic.delete()
...
async def popat(_,CallbackQuery): 
    ...
    if i == 1:
        ...
        await CallbackQuery.edit_message_text(
            f"6️⃣ <b>{title6[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID6})__</u>\n ┗ ⚡ __Maintained By Luna Robot__\n\n7️⃣ <b>{title7[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID7})__</u>\n ┗ ⚡ __Maintained By Luna Robot__\n\n8️⃣ <b>{title8[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID8})__</u>\n ┗ ⚡ __Maintained By Luna Robot__\n\n9️⃣ <b>{title9[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID9})__</u>\n ┗v⚡ __Maintained By Luna Robot__\n\n🔟 <b>{title10[:25]}</b>\n ┣ 💡 <u>__[Get Information](https://t.me/{BOT_USERNAME}?start=info_{ID10})__</u>\n ┗ ⚡ __Maintained By Luna Robot__",    
            reply_markup=InlineKeyboardMarkup(buttons),
        )  
        disable_web_page_preview=True
        return    
