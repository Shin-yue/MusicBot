...
async def kontolmemek_thumb(thumbnail, title, userid, theme, ctitle):
    ...
    image2 = Image.open(f"cache/20211224_015907.png")
    ...
    font = ImageFont.truetype("cache/medium.ttf", 70)
    font2 = ImageFont.truetype("cache/Roboto-Regular.ttf", 49)
    draw.text((30, 543), f"Playing on {ctitle[:13]}...", fill="black", font=font2)
    draw.text((30, 615), f"{title[:19]}", fill="black", font=font)
